                            ...
                            <ul className="flex flex-col space-y-1">
                                <li>
                                    <Link
                                        ...
                                        className={
                                            `flex items-center gap-x-3.5 py-2 px-2.5 text-sm rounded-lg font-medium ${currentPage === '/patient/dashboard'
            ...
            <Box sx={{ display: 'flex' }}>
                ...
                >
                    <Toolbar variant="dense">
                        ...
                        >
                            HMS
                        </Typography> <div className="hidden sm:flex sm:items-center sm:ml-6">
                            <Dropdown
                                align="right"
                                width="48"
                                trigger={
